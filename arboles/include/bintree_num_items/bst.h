...
public:
  ...
  */
  ...
  private:
    ...
    typename bintree<pair<Key, T> >::const_inorderiterator eliterador;
    
    const_iterator(const 
         typename bintree<pair<Key, T> >::const_inorderiterator & i);
  };
...
class iterator {
  ...
  private:
    ...
    typename bintree<pair<Key, T> >::inorderiterator eliterador;
    
    iterator(const typename bintree<pair<Key, T> >::inorderiterator & i);
  };
